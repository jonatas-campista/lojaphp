<?php
	...
	if(isset($_POST['alterar']))
	{
		...
		{				
			...
			$sql = 'UPDATE produto
SET descricao=:descricao, categoria=:categoria,	preco=:preco, imagem=:imagem  WHERE codproduto=:codproduto';
...
<form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST" name="alterar"  enctype="multipart/form-data" class="form-horizontal">
   ...
   <div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" name="descricao" class="form-control" id="inputEmail3" placeholder="descricaodo produto" value="<?php echo $row['descricao']; ?>">
					</div>
				</div>
